...
export const createPetitionDto = z.object({
  title: z
    ...
    .describe("title of the petition"),
  description: z
    .string()
    .trim()
    .min(1, "Description is required")
    .max(1000, "Description is too long")
    .describe("description of the petition"),
  targetAuthority: z
    .string()
    .trim()
    .min(1, "Target Authority is required")
    .max(100, "Target Authority is too long")
    .describe("target authority of the petition"),
  goal: z
    .number()
    .min(1, "Goal must be at least 1")
    .max(100000000, "Goal is too high")
    .describe("signature goal"),
  tags: z
    .array(z.string())
    .max(10, "Maximum 10 tags allowed")
    .default([])
    .describe("tags for the petition"),
  visibility: z
    .enum(["public", "unlisted"])
    .default("public")
    .describe("visibility of the petition"),
});
