...
export const RespondentFormFieldSchema = z.object({
  ...
  options: z.array(z.object({ id: z.string(), value: z.string() })).nullable(),
});
...
export const CollectedAnswerSchema = z.object({
  fieldId: z
    .string()
    .describe("The fieldId of the form field this answer belongs to"),
  value: z
...
export type RespondentAgentGetSessionType = z.infer<
  typeof RespondentAgentGetSessionDto
>;
...
export type RespondentAgentClearSessionType = z.infer<
  typeof RespondentAgentClearSessionDto
>;
