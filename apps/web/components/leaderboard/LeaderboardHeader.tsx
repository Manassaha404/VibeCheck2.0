  ...
  return (
    <div className="text-center mb-20 md:mb-28 relative z-10 flex flex-col items-center">
      <div className="pointer-events-none absolute inset-0 overflow-visible">
        ...
        <div
          className="absolute -top-2 right-[30%] w-5 h-5 bg-[var(--color-mint)] border-2 border-[var(--color-ink-charcoal)] rotate-45 shadow-hard-sm animate-float-slow"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-12 left-[28%] w-4 h-4 bg-[var(--color-tangerine)] border-2 border-[var(--color-ink-charcoal)] rounded-full shadow-hard-sm animate-float-medium"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-2 left-[50%] w-5 h-5 bg-[var(--color-lavender)] border-2 border-[var(--color-ink-charcoal)] rotate-[-20deg] shadow-hard-sm animate-float-slow"
        ...
        <div className="bg-[var(--color-electric-sun)] border-4 border-[var(--color-ink-charcoal)] pt-16 pb-8 px-10 md:px-16 shadow-hard-xl animate-border-shift">
          <h1 className="text-display-lg uppercase text-[var(--color-ink-charcoal)] leading-none tracking-tight text-center relative z-10">
            ...
            <span className="relative inline-block">
              CHAMPIONS
              <span
                className="absolute inset-0 translate-x-[3px] translate-y-[3px] text-[var(--color-pure-white)] -z-10 select-none"
                aria-hidden
              >
                CHAMPIONS
              </span>
