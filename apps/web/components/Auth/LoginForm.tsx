  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <div className="mt-2 text-right">
          <Link
            ...
            className="font-body text-label-sm text-[var(--color-primary)] hover:text-[var(--color-electric-sun)] hover:underline transition-colors"
          >
            Forgot Password?
          </Link>
        </div>
      ...
      <div className="flex items-center my-4">
        ...
        <span className="px-4 font-body text-label-md text-[var(--color-on-surface-variant)] font-bold">
          OR
        </span>
        <div className="flex-1 border-t-2 border-[var(--color-ink-charcoal)]"></div>
      </div>
      ...
      >
        <svg className="w-5 h-5" viewBox="0 0 24 24">
          ...
          <path
            fill="#34A853"
            d="M16.04 18.013c-1.09.703-2.474 1.078-4.04 1.078a7.077 7.077 0 0 1-6.723-4.806L1.248 17.4C3.208 21.348 7.28 24 12 24c2.923 0 5.377-1.054 7.183-2.86l-3.143-3.127Z"
          />
          <path
            fill="#4A90E2"
            d="M19.834 21.14c2.082-2.003 3.33-5.022 3.33-8.498 0-.616-.063-1.218-.175-1.802H12v4.004h6.588c-.3 1.282-1.073 2.45-2.222 3.24l3.468 3.055Z"
          />
          <path
            fill="#FBBC05"
