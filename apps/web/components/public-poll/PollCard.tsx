  ...
  return (
    <div className="bg-pure-white wiggly-border hard-shadow p-8 md:p-12 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, #2C2E2A 2px, transparent 2px)",
      ...
      <div className="relative z-30">
        ...
        >
          <span
            className="inline-block transform -rotate-2 bg-electric-sun px-8 py-6 border-4 border-ink-charcoal hard-shadow text-ink-charcoal"
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-12 relative z-30">
          ...
          {isCommentsAllowed && (
            <div className="mt-12 relative max-w-2xl mx-auto group">
              ...
              <div
                className="bg-electric-sun border-4 border-ink-charcoal p-6 md:p-8 hard-shadow-sm relative z-10 transition-transform focus-within:-translate-y-2 focus-within:shadow-hard"
                style={{ borderRadius: "2px 24px 4px 20px" }}
              >
                <label
                  className="flex items-center gap-3 font-headline-sm text-2xl uppercase mb-4 text-ink-charcoal font-black"
                  htmlFor="poll-comments"
                >
                ...
                <textarea
                  ...
                  style={{
                    ...
                    backgroundImage:
                      "repeating-linear-gradient(transparent, transparent 31px, #2C2E2A20 31px, #2C2E2A20 32px)",
                    lineHeight: "32px",
                    paddingTop: "6px",
                  }}
                />
