      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col">
            <label
              className="font-label-md text-label-md mb-2 uppercase tracking-wide"
              htmlFor="firstName"
            >
              First Name
            </label>
            ...
            />
            {errors.firstName && (
              <span className="text-[var(--color-vivid-coral)] text-sm mt-1 font-bold">
