...
export default function ParticipantSessionHeader({
  ...
  return (
    <div className="flex items-center justify-between bg-[var(--color-ink-charcoal)] text-[var(--color-pure-white)] px-6 py-3 border-4 border-[var(--color-ink-charcoal)] shadow-hard">
      <div className="flex flex-col min-w-0 flex-grow mr-4">
        <h2 className="font-display font-black text-headline-sm uppercase truncate text-[var(--color-pure-white)]">
          {quizTitle}
        </h2>
        {sessionName && (
