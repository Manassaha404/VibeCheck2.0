        ...
        <div className="relative max-w-4xl mx-auto mb-8 w-full">
          ...
          >
            ...
            <div className="bg-[var(--color-leaf-green)] border-2 border-[var(--color-ink-charcoal)] p-2 rounded-lg shadow-hard transform -rotate-3 self-end mr-4">
              <span className="font-display font-bold text-sm text-[var(--color-ink-charcoal)]">
                +84% Engagement
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] p-4 rounded-xl shadow-hard flex items-center gap-3 transform -rotate-6">
              ...
              <div className="text-left">
                <div className="text-xs font-bold text-[var(--color-ink-charcoal)]">
                  Live Poll
                </div>
                <div className="text-[10px] text-[var(--color-tertiary)] font-bold">
                  1.2k responses
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              Create polls, quizzes, petitions and forms in seconds. Gather
              real-time vibes from your community and turn data into decisions
              with a punch.
            </motion.p>
