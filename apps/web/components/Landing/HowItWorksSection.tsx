            ...
            <div ref={stepsRef} className="space-y-8 relative">
              ...
              {steps.map((step) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-display font-black text-headline-sm mb-2">
                      {step.title}
                    </h4>
            ...
            <div className="relative w-full max-w-md aspect-square flex flex-col justify-center items-center">
              ...
              >
                <div className="flex justify-between items-center mb-3">
                  <span className="text-label-sm font-bold uppercase tracking-wider text-[var(--color-ink-charcoal)]">
                    Results
                  </span>
                  <span className="text-label-sm font-bold bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] px-2 py-0.5 rounded-full">
                    482 votes
                  </span>
                </div>
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-label-md font-bold text-sm">
                      Flexible Hours
                    </span>
