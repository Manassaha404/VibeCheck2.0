    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div className="bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] shadow-hard p-6 flex flex-col justify-between gap-2 h-full">
        <div className="flex flex-col gap-2">
          <span className="text-label-md font-body text-[var(--color-ink-charcoal)] opacity-70">
            Total Questions
          </span>
          <span className="text-[32px] md:text-headline-lg font-display font-extrabold text-[var(--color-ink-charcoal)] leading-[1]">
            {totalQuestions}
          </span>
        </div>
