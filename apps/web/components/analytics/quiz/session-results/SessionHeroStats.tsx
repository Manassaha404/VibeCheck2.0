...
export function SessionHeroStats({
  averageScore,
  totalParticipants,
}: {
  averageScore: number;
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-[var(--color-electric-sun)] border-4 border-ink-charcoal shadow-hard-xl rounded-xl p-10 flex flex-col justify-center items-center text-center relative overflow-hidden group hover-lift card-lift">
        ...
        <h2 className="font-headline-sm uppercase tracking-widest mb-4 relative z-10">
          Average Score
        </h2>
        <div className="font-display-lg text-[120px] leading-none font-black text-ink-charcoal relative z-10">
          {averageScore}
        </div>
      </div>
      ...
      <div className="bg-[var(--color-leaf-green)] border-4 border-ink-charcoal shadow-hard-xl rounded-xl p-10 flex flex-col justify-center items-center text-center relative overflow-hidden group hover-lift card-lift">
        ...
        <div className="absolute top-4 left-4 bg-[var(--color-pure-white)] border-2 border-ink-charcoal px-4 py-1 rounded-full font-bold -rotate-3 shadow-hard-sm">
          LIVE NOW
        </div>
      </div>
    </section>
