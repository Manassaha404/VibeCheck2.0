        ...
        return (
          <div
            ...
            className={[
              ...
              isCorrect
                ? "bg-[var(--color-leaf-green)] shadow-[8px_8px_0px_0px_var(--color-leaf-green)] scale-[1.02] animate-pulse"
                : "bg-[var(--color-surface-container)] shadow-hard",
            ...
            <div className="relative z-10 flex justify-between w-full px-6 items-center">
              <span
                className={[
                  ...
                  isCorrect
                    ? "text-[var(--color-pure-white)] mix-blend-normal drop-shadow-md"
                    : "text-[var(--color-ink-charcoal)] mix-blend-hard-light",
                ].join(" ")}
              >
                {isCorrect && <span>✓</span>}
              ...
              <span
                className={`font-display font-bold text-headline-sm bg-[var(--color-pure-white)] px-3 py-1 border-2 border-[var(--color-ink-charcoal)] text-[var(--color-ink-charcoal)] ${badgeRotation} z-20`}
              >
                {option.votes} Vibes
              </span>
            </div>
