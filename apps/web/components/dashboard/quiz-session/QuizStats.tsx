    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div className="bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] shadow-hard p-6 flex flex-col justify-between gap-2 h-full">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-[32px] md:text-headline-lg font-display font-extrabold text-[var(--color-ink-charcoal)] leading-[1]">10</span>
        </div>
      ...
      <div className="bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] shadow-hard p-6 flex flex-col justify-between gap-2 h-full">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-[32px] md:text-headline-lg font-display font-extrabold text-[var(--color-ink-charcoal)] leading-[1]">1,240</span>
        </div>
