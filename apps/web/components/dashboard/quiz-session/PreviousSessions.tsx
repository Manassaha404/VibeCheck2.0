  ...
  return (
    <div className="bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] shadow-hard p-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-[var(--color-canvas-cream)] border-2 border-[var(--color-ink-charcoal)] gap-4">
          <div className="flex flex-col">
            <span className="font-bold text-body-lg font-body">Calculus II Final Prep</span>
            <span className="text-label-sm font-body opacity-70">Oct 12, 2023 • 850 Participants</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-[var(--color-canvas-cream)] border-2 border-[var(--color-ink-charcoal)] gap-4">
          <div className="flex flex-col">
            <span className="font-bold text-body-lg font-body">Organic Chemistry Quiz</span>
            <span className="text-label-sm font-body opacity-70">Oct 05, 2023 • 1,120 Participants</span>
          </div>
          <button className="bg-[var(--color-electric-sun)] text-label-md font-body font-bold text-[var(--color-ink-charcoal)] px-4 py-2 border-2 border-[var(--color-ink-charcoal)] btn-press transition-all flex items-center gap-2 shadow-hard">
