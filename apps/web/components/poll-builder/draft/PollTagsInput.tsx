...
export function PollTagsInput() {
  const { watch, setValue, formState: { errors } } = useFormContext<PollDraftFormValues>();
        ...
        <div className="flex flex-wrap gap-2 min-h-[32px]">
          ...
          {tags.length === 0 && (
            <span className="text-on-surface-variant font-body-sm text-body-sm italic flex items-center h-8">
              No tags added yet. Add some to help people find your poll!
            </span>
          )}
        </div>
