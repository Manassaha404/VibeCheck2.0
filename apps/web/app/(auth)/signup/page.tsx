        ...
        <div className="relative z-10">
          <div className="text-center mb-4">
            ...
            <p className="font-body text-label-md text-[var(--color-on-surface-variant)] leading-tight">
              Create your account to start building interactive forms and
              quizzes.
            </p>
          </div>
          ...
          <div className="mt-4 text-center font-body text-label-md">
            <p>
              ...
              <Link
                href="/login"
                className="font-bold underline decoration-2 decoration-[var(--color-electric-sun)] underline-offset-4 hover:text-[var(--color-primary)] transition-colors"
              >
                Log in
              </Link>
            </p>
