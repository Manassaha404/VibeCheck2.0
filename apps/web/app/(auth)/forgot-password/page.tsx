      ...
      <div className="max-w-md w-full bg-[var(--color-pure-white)] border-2 border-[var(--color-ink-charcoal)] rounded-2xl hard-shadow-xl p-6 sm:p-8 relative z-10">
        ...
        <div className="relative z-10">
          <div className="text-center mb-6">
            ...
            <h1 className="font-display text-headline-sm mb-1">
              Lost Your Key?
            </h1>
            <p className="font-body text-label-md text-[var(--color-on-surface-variant)] leading-tight">
              Enter your email address and we'll send you a link to retrieve
              your creative power.
            </p>
          </div>
          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-1">
                <label
                  className="block font-body text-label-sm"
                  htmlFor="email"
                >
                  Email Address
                </label>
          ...
          <div className="mt-6 text-center border-t-2 border-[var(--color-ink-charcoal)] pt-4">
            <Link
              href="/signin"
              className="inline-flex items-center gap-2 font-body text-label-sm text-[var(--color-ink-charcoal)] hover:text-[var(--color-electric-sun)] transition-colors group"
            >
